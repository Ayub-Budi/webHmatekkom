...
@section('hero')
    <img src="{{asset('user/images/logo.png')}}" style="margin-right:5px; width:200px; height:auto;"/>
    <h1>Himpunan Mahasiswa Teknologi Komputer</h1>
    <h2> HIMATEKKOM adalah organisasi kemahasiswaan untuk mahasiswa Teknologi Komputer yang bertujuan mengembangkan potensi akademik dan non-akademik anggotanya melalui berbagai kegiatan inovatif dan berorientasi teknologi.</h2>
