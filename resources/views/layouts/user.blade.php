  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero">
          <!-- <img src="{{asset('user/images/logo.png')}}" style="margin-right:5px"/></img> -->
          <img src="{{asset('user/images/logo.png')}}" style="margin-right:5px; width:40px; height:auto;"/>

          <h2 class="d-inline text-light">HIMATEKKOM</h2>
        </a>
      </div>
